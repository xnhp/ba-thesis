...
% rerun only on ADReorg*Last*
% DONE config-gnn-basic-both
% DONE config-gnn-basic-projection
% DONE config-gnn-basic-simple
% DONE config-gnn-degrees
% DONE config-gnn-degrees-basic
...
\begin{figure}[h]
  ...
  \begin{subfigure}{0.48\linewidth}
    \pic{feature-importance/comparison/roc-pdmap-bak.png}
    \caption{(\ADLast $\rightarrow$ \PDMap)}
  \end{subfigure}
  \begin{subfigure}{0.48\linewidth}
    \pic{feature-importance/comparison/roc-reconmap-bak.png}
    \caption{(\ADLast $\rightarrow$ \ReconMap)}
  \end{subfigure}
...
% sune, marek for answering questions
